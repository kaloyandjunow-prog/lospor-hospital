...
изправността, а `sudo losporctl support-bundle create` записва файл за
поддръжката на LOSPOR без лични данни. [Архивиране и възстановяване](backup-restore.bg.md)
