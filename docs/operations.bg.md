...
- Ако тайните са се променили, съхранете ги отново: `sudo losporctl secrets escrow /media/usb`.
- **Поддръжка → Смяна на данните за достъп** (или `sudo losporctl secrets rotate`,
  ...
  отново. След това съхранете тайните отново със `sudo losporctl secrets escrow`.
