...
export function LanguageSwitcher({ currentLocale, context = "public", prominent = false }: {
  ...
  return (
    <div role="group" aria-label={t("selectorLabel")} className={`flex items-center gap-0.5 border border-slate-300 dark:border-[#4a4a4a] rounded-lg overflow-hidden shadow-sm ${prominent ? "text-base" : "text-sm"}`}>
