...
describe("Hospital LabResults external-AI boundary", () => {
  beforeEach(() => {
    mocks.capability.enabled = false
    mocks.capability.reason = "DISABLED_BY_DEPLOYMENT"
  })

  it("contains no image capture path when policy is disabled", () => {
  ...
  it("renders capture controls only after explicit enablement", () => {
