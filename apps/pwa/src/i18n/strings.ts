...
export const STRINGS = {
  en: {
    ...
    authenticationUnavailable: "The appliance authentication policy could not be verified. Try again or contact the appliance administrator.",
    usernameRequirements: "Use 3–64 characters, begin with a Latin letter, and use only Latin A–Z/a–z, digits, dot, underscore, or hyphen. Spaces, @, /, \\, and control characters are not allowed.",
    usernameCasePolicy: "Capitalization is preserved, but login and uniqueness are case-insensitive.",
    usernameDisplayNamePolicy: "Your display name is separate and may use Cyrillic.",
    forgotPassword: "Forgot password?",
    accountAccessHelp: "Ask your hospital administrator for an activation or recovery link",
    accountsCreatedByAdministrator: "Accounts are created by your hospital administrator.",
    registrationAvailable: "Create an account",
    settings: "Settings",
    ...
    auditUnknownAction: "Unknown historical action",
    auditPrivacyNotice: "Raw details and internal target identifiers are intentionally not displayed.",
    events: "events",
    ...
    exportDataMsg: "Data export is available under Settings in your Hospital web app.",
  ...
  bg: {
    ...
    invalidUsername: "Въведете валидно потребителско име.",
    authenticationUnavailable: "Политиката за вход на системата не може да бъде потвърдена. Опитайте отново или се свържете с администратора на системата.",
    usernameRequirements: "Използвайте от 3 до 64 знака, започнете с латинска буква и използвайте само латински букви A–Z/a–z, цифри, точка, долна черта или тире. Не се допускат интервали, @, /, \\ или управляващи знаци.",
    usernameCasePolicy: "Изписването се запазва, но входът и уникалността не различават главни от малки букви.",
    usernameDisplayNamePolicy: "Името за показване е отделно и може да бъде на кирилица.",
    forgotPassword: "Забравена парола?",
    accountAccessHelp: "Поискайте линк за активиране или възстановяване от администратора на лечебното заведение",
    accountsCreatedByAdministrator: "Акаунтите се създават от администратора на лечебното заведение.",
    registrationAvailable: "Създаване на акаунт",
    settings: "Настройки",
    ...
    auditAllActions: "Всички действия",
    auditUnknownAction: "Неизвестно историческо действие",
    auditPrivacyNotice: "Суровите детайли и вътрешните идентификатори на обектите умишлено не се показват.",
    events: "събития",
    ...
    exportDataMsg: "Експортът на данни е достъпен в Настройки в локалното уеб приложение на лечебното заведение.",
