...
export type AuthSessionWhereInput = {
  ...
  clientType?: Prisma.EnumAuthSessionClientTypeFilter<"AuthSession"> | $Enums.AuthSessionClientType
  deviceLabel?: Prisma.StringFilter<"AuthSession"> | string
...
export type AuthSessionScalarWhereWithAggregatesInput = {
  ...
  clientType?: Prisma.EnumAuthSessionClientTypeWithAggregatesFilter<"AuthSession"> | $Enums.AuthSessionClientType
  deviceLabel?: Prisma.StringWithAggregatesFilter<"AuthSession"> | string
...
export type EnumAuthSessionClientTypeFieldUpdateOperationsInput = {
  set?: $Enums.AuthSessionClientType
}
...
export type AuthSessionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"jti" | "userId" | "clientType" | "deviceLabel" | "issuedAt" | "lastSeenAt" | "expiresAt" | "revokedAt" | "revokedReason", ExtArgs["result"]["authSession"]>
...
export interface AuthSessionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `jti`
   * const authSessionWithJtiOnly = await prisma.authSession.findMany({ select: { jti: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AuthSessions and only return the `jti`
   * const authSessionWithJtiOnly = await prisma.authSession.createManyAndReturn({
   *   select: { jti: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more AuthSessions and only return the `jti`
   * const authSessionWithJtiOnly = await prisma.authSession.updateManyAndReturn({
   *   select: { jti: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AuthSessionFieldRefs {
  ...
  readonly clientType: Prisma.FieldRef<"AuthSession", 'AuthSessionClientType'>
