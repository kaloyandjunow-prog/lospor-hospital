...
export const preopSchema = z.object({
  ...
  allergies:                z.boolean().nullable().optional(),
  allergyDetails:           z.union([z.string(), z.array(labelledItem)]).optional(),
  latexAllergy:             z.boolean().nullable().optional(),
  ...
  retrognathia:           z.boolean().nullable().optional(),
  prominentIncisors:      z.boolean().nullable().optional(),
  facialHair:             z.boolean().nullable().optional(),
  difficultAirwayHistory: z.boolean().nullable().optional(),
  ...
  povocSurgeryAtLeast30Minutes: z.boolean().nullable().optional(),
  povocAgeAtLeast3Years:        z.boolean().nullable().optional(),
  povocStrabismusSurgery:       z.boolean().nullable().optional(),
  povocHistory:                 z.boolean().nullable().optional(),
...
export const postopSchema = z.object({
  ...
  ponv:               z.boolean().nullable().optional(),
