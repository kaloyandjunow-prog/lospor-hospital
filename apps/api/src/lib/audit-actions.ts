...
export const AUDIT_ACTION_REGISTRY = defineAuditActions([
  ...
  { code: "HOSPITAL_EHR_VITAL_CODE_MAP", category: "SECURITY", labels: { bg: "Съпоставен код за жизнен показател от ЕЗД", en: "EHR vital-sign code mapped" } },
  { code: "HOSPITAL_EHR_VITAL_CODE_UNMAP", category: "SECURITY", labels: { bg: "Премахната съпоставка на код за жизнен показател от ЕЗД", en: "EHR vital-sign code mapping removed" } },
  { code: "HOSPITAL_EHR_MEDICATION_CODE_MAP", category: "SECURITY", labels: { bg: "Съпоставен лекарствен код от ЕЗД", en: "EHR medication code mapped" } },
